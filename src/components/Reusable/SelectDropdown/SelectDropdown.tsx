...
const SelectDropdown: React.FC<TSelectDropdownProps> = ({ label, items, icon, onSelect, selectedData }) => {
  ...
  return (
    <div ref={dropDownRef} className="relative font-plus-jakarta-sans">
      <button
        ...
        className="px-4 py-[14px] bg-white border border-[#CAD5E2] flex items-center justify-between text-neutral-700 text-xl leading-6 rounded-lg w-[277px] cursor-pointer 
