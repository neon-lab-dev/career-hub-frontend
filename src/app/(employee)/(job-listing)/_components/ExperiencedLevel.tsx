...
const ExperiencedLevel : React.FC<TExperiencedLevelProps> = ({experienceLevel, setExperienceLevel}) => {
  ...
  const handleExperienceLevel = (level: string) => {
    ...
    return (
        ...
        <div className="dropdown">
          ...
          >
           <li onClick={() => handleExperienceLevel("Fresher")} className="cursor-pointer">Fresher</li>
            <li onClick={() => handleExperienceLevel("Entry Level")} className="cursor-pointer">Entry Level</li>
            <li onClick={() => handleExperienceLevel("Experienced")} className="cursor-pointer">Experienced</li>
          </ul>
        </div>
      </div>
    );
