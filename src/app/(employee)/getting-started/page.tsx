  ...
  <GetStartedLayout progress={Step * 12.5} goToPreviousStep={goToPreviousStep}>
    <div className="flex justify-center w-full">
      <div className="flex justify-center gap-4">
        ...
        {Step === 5 && (
          <div>
            ...
            <div className='flex flex-col justify-center py-4'>
              ...
              <CertificateModel formData={formData} setFormData={setFormData} showOnMount={showProjectModal} />
              <div className='flex max-lg:justify-center justify-start max-lg:mt-32 mb-10 mt-5'>
                <Button
                  variant="primary"
                  type="button"
        ...
        {Step === 7 && (
          <ResumeUpload setSelectedFile={setSelectedFile} handleContinue={handleContinue} />
        )}
